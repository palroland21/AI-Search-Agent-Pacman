...
> Project report/details: see `Search_Agent_for_Pacman.pdf`.
...
All tasks were completed and passed the autograder with max score.
...
> Exact filenames can vary depending on the starter package.
...
Run Pacman with a search agent:
```bash
